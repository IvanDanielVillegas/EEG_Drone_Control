...
################### Control del drone ####################
    ...
    Operaciones = {0: Despegar,3: Abajo,}
...
def start_board_Ultracortex():
    ...
    try:
        ...
        board = OpenBCICyton(port='/dev/ttyUSB2', daisy=True)
